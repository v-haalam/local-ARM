...
namespace Amdocs.Teams.App.Communicator.Common.Test.Services.MicrosoftGraph
{
    using System;
    ...
    using Amdocs.Teams.App.Communicator.Common.Test.Services.Mock;
    ...
    {
        /// <summary>
        /// Test case to check if Users service is instantiated successfully.
        /// </summary>
        [Fact]
