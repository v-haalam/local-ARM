...
namespace Amdocs.Teams.App.Communicator
{
    ...
    using Amdocs.Teams.App.Communicator.Common.Services;
    ...
    using Amdocs.Teams.App.Communicator.Common.Services.MessageQueues.ExportQueue;
    ...
    using Amdocs.Teams.App.Communicator.Common.Services.User;
    using Amdocs.Teams.App.Communicator.Controllers;
    using Amdocs.Teams.App.Communicator.Controllers.Options;
    using Amdocs.Teams.App.Communicator.DraftNotificationPreview;
    using Amdocs.Teams.App.Communicator.Localization;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<AmdocsCommunicatorBotFilterMiddleware>();
            services.AddSingleton<AmdocsCommunicatorBotAdapter>();
