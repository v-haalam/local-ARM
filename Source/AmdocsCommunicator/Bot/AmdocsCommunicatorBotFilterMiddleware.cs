// <copyright file="AmdocsCommunicatorBotFilterMiddleware.cs" company="Microsoft">
...
namespace Amdocs.Teams.App.Communicator.Bot
{
    ...
    /// </summary>
    public class AmdocsCommunicatorBotFilterMiddleware : IMiddleware
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AmdocsCommunicatorBotFilterMiddleware"/> class.
        /// </summary>
        /// <param name="botFilterMiddlewareOptions">The bot filter middleware options.</param>
        public AmdocsCommunicatorBotFilterMiddleware(IOptions<BotFilterMiddlewareOptions> botFilterMiddlewareOptions)
        {
        ...
        {
            return AmdocsCommunicatorBotFilterMiddleware.MsTeamsChannelId.Equals(
